...
// fs.writeFileSync(path.resolve(__dirname, "./subcounties.ts"), JSON.stringify(clean))

// const clean = rawCounties.map((county: any) => {
//   return {
//     county_code: county.county_code,
//     county_name: county.county,
//     county_search_string: county.county.replace(/'/g, "").replace(/ /g, "-"),
...
// fs.writeFileSync(path.resolve(__dirname, "./counties.ts"), JSON.stringify(clean))
